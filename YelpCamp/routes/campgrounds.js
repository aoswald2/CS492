...
var { isLoggedIn, checkUserCampground, checkUserComment, isSafe } = middleware; // destructuring assignment
...
//     if(err) {
//         req.flash("Whoops! Something went wrong.");
...
router.put("/:id", isSafe, isLoggedIn, checkUserCampground, function(req, res){
//   geocoder.geocode(req.body.location, function (err, data) {
//     if(err) {
//         req.flash("Whoops! Something went wrong.");
//         return res.redirect("back");
